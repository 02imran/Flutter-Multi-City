...
import 'package:fluttermulticity/ui/common/facebook_login_web_view.dart';
...
import 'package:fluttermulticity/viewobject/holder/apple_login_parameter_holder.dart';
import 'package:fluttermulticity/viewobject/holder/facebook_login_user_holder.dart';
import 'package:fluttermulticity/viewobject/holder/fb_login_parameter_holder.dart';
import 'package:fluttermulticity/viewobject/holder/google_login_parameter_holder.dart';
import 'package:fluttermulticity/viewobject/holder/user_login_parameter_holder.dart';
import 'package:fluttermulticity/viewobject/holder/user_register_parameter_holder.dart';
...
class UserProvider extends PsProvider {
    ...
    subscription = userListStream.stream.listen((PsResource<User> resource) {
      ...
      if (!isDispose) {
        if (_user != null && _user.data != null) {
          replaceLoginUserId(_user.data.userId);
  ...
  Future<dynamic> getUser(
    ...
    _user = await _repo.getUser(userListStream, loginUserId,
        isConnectedToInternet, PsStatus.PROGRESS_LOADING);
