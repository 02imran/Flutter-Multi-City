...
import 'package:fluttermulticity/provider/token/token_provider.dart';
...
import 'package:fluttermulticity/repository/token_repository.dart';
...
class AdsHowManyDayWidget extends StatefulWidget {
  const AdsHowManyDayWidget(
      {Key key, @required this.item, @required this.tokenProvider})
      : super(key: key);
