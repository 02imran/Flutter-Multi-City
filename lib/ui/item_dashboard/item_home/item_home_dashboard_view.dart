                          ...
                          Container(
                            ...
                            child: Text(
                              Utils.getString(context,
                                  'dashboard__popular_item_description'),
                                    ...
                                    if (itemProvider.itemList.status ==
                                      ...
                                      return ItemHorizontalListItem(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (result == null) {
                                            setState(() {
                                              itemProvider.loadItemListByKey(
                                                  itemParameterHolder);
                                            });
                                          }
                                        },
                                        ...
                                        (BuildContext context, int index) {
                                          if (itemProvider.itemList.status ==
                                            ...
                                            final Item item = itemProvider
                                                .itemList.data[index];
                                            return ItemHorizontalListItem(
                                              coreTagKey: itemProvider.hashCode
                                                      .toString() +
                                                  item.id,
                                              item: itemProvider
                                                  .itemList.data[index],
              ...
              return FadeTransition(
                  ...
                  child: Transform(
                      ...
                      child: (collectionProvider.itemCollectionList != null &&
                              collectionProvider
                                  .itemCollectionList.data.isNotEmpty)
                          ? ListView.builder(
                              scrollDirection: Axis.vertical,
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                          ...
                          ? Column(
                              ...
                              children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      Utils.getString(context,
                                          'dashboard__category_description'),
                                      textAlign: TextAlign.start,
                                      style:
                                          Theme.of(context).textTheme.bodyText1,
                                    ),
