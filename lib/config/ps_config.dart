...
class PsConfig {
  ...
  static const String ps_app_url =
      'https://www.panacea-soft.com/flutter-multi-city-admin/index.php/';

  static const String ps_app_image_url =
      'https://www.panacea-soft.com/flutter-multi-city-admin/uploads/';

  static const String ps_app_image_thumbs_url =
      'https://www.panacea-soft.com/flutter-multi-city-admin/uploads/thumbnail/';
...
// static const ps_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  //     'ca-app-pub-8907881762519005/7945413094';
  // // static String androidAdMobUnitIdApiKey =
  ...
  // static String iosAdMobUnitIdApiKey = 'ca-app-pub-8907881762519005/2786501478';
  ...
  static const int POPULAR_CITY_LOADING_LIMIT = 10;
  static const int NEW_CITY_LOADING_LIMIT = 10;
  static const int RECOMMAND_CITY_LOADING_LIMIT = 10;
  static const int BLOG_ITEM_LOADING_LIMIT = 10;
  ...
  ///
  static const String tmpImageFolderName = 'FlutterCity';
}
